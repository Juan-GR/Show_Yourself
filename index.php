...
<html>
    ...
    <body>
        <header class="contenedorHeader">
            <div class="titulo">
                <img src="view/styles/logo.png" alt="logo"/>
            </div>
        ...
        <main>
            ...
            <section class="seccion2">
                ...
                <p>
                <img src="view/styles/camara.png">
                </p>
            </section>
            <section class="seccion3">
                <img src="view/styles/movil.png">
                <div>
        ...
        <footer>
            ...
            <p><img src="view/styles/logo.png" alt="logo"/></p>
        </footer>
        <?php
